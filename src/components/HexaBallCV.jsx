...
export default function Model({ ...props }) {
    const group = useRef()
    const { nodes, materials } = useGLTF('/blackBall6.gtlf')
    return (
        <group ref={group} {...props} dispose={null}>
            ...
            <mesh
                geometry={nodes.Smoke_Domain.geometry}
                material={materials['Smoke Domain Material.001']}
                position={[0, 2.23, 0]}
                scale={[3.08, 4.08, 3.08]}
            />
            <mesh geometry={nodes.Sphère.geometry} material={materials.Matériau} position={[0, 1.23, 0]} scale={2.08} />
        </group>
    )
}

useGLTF.preload('/blackBall6.gtlf')
